...
public class SupplierManager {
	...
	public boolean modifySupplier(Supplier supplier, Supplier old) throws BusinessException {
		// check right
		if (!supplier.getSupplierID().equals(old.getSupplierID()) && search(supplier) != null) {
			throw new BusinessException("supplies id has existed");
		}
