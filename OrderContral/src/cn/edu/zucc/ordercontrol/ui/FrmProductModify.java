...
public class FrmProductModify extends JDialog implements ActionListener {
	...
	public FrmProductModify(JDialog f, String s, boolean b,List<ProductType> list,Product product22) {
		super(f, s, b);
		old=product22;
		...
		edtid.setText(old.getProductId());
		edtname.setText(old.getProductName());
		edtprice.setText(old.getProductPrice());
		brief.setText(old.getProductIntroduction());
		combotype.setSelectedItem(old.getProductTypeID());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnCancel) {
			...
			try {
				(new ProductManager()).modifyProduct(product, old);
				this.setVisible(false);
