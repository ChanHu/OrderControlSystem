...
public class FrmSupplierModify extends JFrame implements ActionListener{
	...
	public FrmSupplierModify(Frame  f, String s, boolean b,Supplier supplier) {
		super(s);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnCancel) {
			...
			(new SupplierDao()).modifySupplier(pub);
			this.setVisible(false);
			try {
